// Copyright (C) 2025 Bian Albaihaqi
// This file is part of Bian-porto-2-nextJs.
            ...
            <div className="section">
              <div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
                ...
                >
                  ...
                  >
                    Hi! I&rsquo;am Bian Albaihaqi, a Fullstack Developer with
                    experience in building scalable and high-performance web
                    applications. I am passionate about modern technologies,
                    clean code, and well-structured architectures, with hands-on
                    experience across backend, frontend, and deployment
                    workflows.
                  </motion.p>
                  <motion.div
            ...
            <div className="section">
              <div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
                ...
                <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
                  ...
                  >
                    <a href="mailto:bianalbaihaqi190@gmail.com?subject=Hello&body=Hello Bian,">
                  ...
                  <div className="flex justify-center items-center space-x-4">
                    <motion.a
                      href="mailto:bianalbaihaqi190@gmail.com?subject=Hello&body=Hello Bian,"
                    ...
                    <motion.a
                      href="https://github.com/Albaihaqi354"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                    ...
                    <motion.a
                      href="https://www.instagram.com/bian.disini/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                      initial={{ opacity: 0, y: 40 }}
